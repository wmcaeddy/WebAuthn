...
- [ ] Task: Update `getUserHandle` in `server.php` to return the hex-encoded `userName`.
- [ ] Task: Verify that `getCreateArgs` correctly converts this hex back to binary for the client.
