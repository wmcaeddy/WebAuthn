        ...
        <div data-v-0ad70c51="" class="main-box">
            ...
            <footer data-v-ce58d66b="" class="main-bottom bg-[#001e1e]">
                <div data-v-ce58d66b="" class="css-q2ifcv_logo py-[40px] sm:py-[60px] lg:py-[80px]">
                    <div data-v-ce58d66b="" class="flex flex-col items-center">
                        <img data-v-ce58d66b="" src="assets/sjm/7jcNEosm2P1767321339567_SJM-Logo_TC_T-gold_L-gold-website.png" class="w-[240px] mb-[40px]">
                        <div data-v-ce58d66b="" class="flex flex-wrap justify-center gap-x-[32px] gap-y-[24px] mb-[40px] opacity-80">
                            <img data-v-ce58d66b="" src="assets/sjm/Q8S9IwmDyE1767321379880_logo-glp-gold-color.png" class="h-[32px]">
                            <img data-v-ce58d66b="" src="assets/sjm/9a9dnIdCSg1767321406081_logo-gl-gold-color.png" class="h-[32px]">
                            <img data-v-ce58d66b="" src="assets/sjm/qFZMImi58c1767321441136_logo-hl-gold.png" class="h-[32px]">
                            <img data-v-ce58d66b="" src="assets/sjm/34gguiprOr1767321528008_logo-jai-alai-oceanus-gold.png" class="h-[32px]">
                            <img data-v-ce58d66b="" src="assets/sjm/THBSW7EBxL1767321556362_logo-ponte16-gold.png" class="h-[32px]">
                            <img data-v-ce58d66b="" src="assets/sjm/Or6DWYwmB91767321692371_logo-kampek-market-gold-vertical.png" class="h-[32px]">
                            <img data-v-ce58d66b="" src="assets/sjm/gptAH89cco1767321836162_larc-logo-gold.png" class="h-[32px]">
                        </div>
                        <div data-v-ce58d66b="" class="text-[#a8996e] text-[12px] text-center">©2026 澳娛綜合。保留所有權利。</div>
                    </div>
                </div>
            </footer>
        </div>
